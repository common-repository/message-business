...
/**
 * Message_Business_Segment Class Doc Comment
 *
 * @category    Class */
 // @description Message_Business_Segment for contact
/** 
 * @package     Swagger\Client
 * @author      http://github.com/swagger-api/swagger-codegen
 * @license     http://www.apache.org/licenses/LICENSE-2.0 Apache Licene v2
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Message_Business_Segment implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'Message_Business_Segment';
    ...
    /**
     * Sets mode
     * @param string $mode Union by default
     * @return $this
     */
