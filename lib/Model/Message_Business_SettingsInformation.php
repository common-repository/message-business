<?php
/**
 * Message_Business_SettingsInformation
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * Message_Business_SettingsInformation Class Doc Comment
 *
 * @category    Class */
/** 
 * @package     Swagger\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Message_Business_SettingsInformation implements ArrayAccess
{
    /**
      * The original name of the model.
      * @var string
      */
    protected static $swaggerModelName = 'Message_Business_SettingsInformation';
    ...
    /**
     * Sets attribute_type
     * @param map[string,string] $attribute_type
     * @return $this
     */
