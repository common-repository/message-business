<?php
/**
 * Message_Business_ObjectSerializer
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * Message_Business_ObjectSerializer Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   http://github.com/swagger-api/swagger-codegen
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Message_Business_ObjectSerializer
{
    ...
    public static function deserialize($data, $class, $httpHeaders = null, $discriminator = null)
    {
        if (null === $data) {
            ...
            if (array_key_exists('Content-Disposition', $httpHeaders) &&
                ...
                $filename = Message_Business_Configuration::getDefaultConfiguration()->getTempFolderPath() . sanitizeFilename($match[1]);
            } else {
                $filename = tempnam(Message_Business_Configuration::getDefaultConfiguration()->getTempFolderPath(), '');
            }
            $deserialized = new \SplFileObject($filename, "w");
            $byte_written = $deserialized->fwrite($data);
 
            if (Message_Business_Configuration::getDefaultConfiguration()->getDebug()) {
                error_log("[DEBUG] Written $byte_written byte to $filename. Please move the file to a proper folder or delete the temp file after processing.".PHP_EOL, 3, Message_Business_Configuration::getDefaultConfiguration()->getDebugFile());
            }
